(() => {
    ...
    const priceCards = document.querySelectorAll(".pricing-section__card");
    const priceBtns = document.querySelectorAll(".pricing-section__btn");
    priceBtns.forEach((btn => {
        btn.addEventListener("click", (() => {
            priceCards.forEach((elem => elem.classList.remove("_active")));
